...
(cl:defmethod cl:initialize-instance :after ((m <AdjustParams>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'AdjustParams)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name pose_adjust-msg:<AdjustParams> is deprecated: use pose_adjust-msg:AdjustParams instead.")))

(cl:ensure-generic-function 'y-val :lambda-list '(m))
(cl:defmethod y-val ((m <AdjustParams>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pose_adjust-msg:y-val is deprecated.  Use pose_adjust-msg:y instead.")
  (y m))

(cl:ensure-generic-function 'z-val :lambda-list '(m))
(cl:defmethod z-val ((m <AdjustParams>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pose_adjust-msg:z-val is deprecated.  Use pose_adjust-msg:z instead.")
  (z m))

(cl:ensure-generic-function 'y_rotate_angle-val :lambda-list '(m))
(cl:defmethod y_rotate_angle-val ((m <AdjustParams>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pose_adjust-msg:y_rotate_angle-val is deprecated.  Use pose_adjust-msg:y_rotate_angle instead.")
  (y_rotate_angle m))

(cl:ensure-generic-function 'z_rotate_angle-val :lambda-list '(m))
(cl:defmethod z_rotate_angle-val ((m <AdjustParams>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pose_adjust-msg:z_rotate_angle-val is deprecated.  Use pose_adjust-msg:z_rotate_angle instead.")
  (z_rotate_angle m))
