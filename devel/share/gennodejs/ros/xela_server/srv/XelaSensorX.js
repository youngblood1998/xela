...
class XelaSensorXRequest {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type XelaSensorXRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type XelaSensorXRequest
    let len;
    let data = new XelaSensorXRequest(null);
  ...
  static datatype() {
    ...
    return 'xela_server/XelaSensorXRequest';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new XelaSensorXRequest(null);
...
class XelaSensorXResponse {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type XelaSensorXResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type XelaSensorXResponse
    let len;
    let data = new XelaSensorXResponse(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new XelaSensorXResponse(null);
...
module.exports = {
  Request: XelaSensorXRequest,
  Response: XelaSensorXResponse,
  md5sum() { return 'fc5714e73aa3fe2b97b854cd8a61a925'; },
  datatype() { return 'xela_server/XelaSensorX'; }
};
