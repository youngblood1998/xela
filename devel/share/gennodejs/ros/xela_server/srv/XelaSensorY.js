...
class XelaSensorYRequest {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type XelaSensorYRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type XelaSensorYRequest
    let len;
    let data = new XelaSensorYRequest(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new XelaSensorYRequest(null);
...
class XelaSensorYResponse {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type XelaSensorYResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type XelaSensorYResponse
    let len;
    let data = new XelaSensorYResponse(null);
  ...
  static datatype() {
    // Returns string type for a service object
    return 'xela_server/XelaSensorYResponse';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new XelaSensorYResponse(null);
...
module.exports = {
  Request: XelaSensorYRequest,
  Response: XelaSensorYResponse,
  md5sum() { return 'fc5714e73aa3fe2b97b854cd8a61a925'; },
  datatype() { return 'xela_server/XelaSensorY'; }
};
