...
class XelaSensorXYRequest {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type XelaSensorXYRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type XelaSensorXYRequest
    let len;
    let data = new XelaSensorXYRequest(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new XelaSensorXYRequest(null);
...
class XelaSensorXYResponse {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type XelaSensorXYResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type XelaSensorXYResponse
    let len;
    let data = new XelaSensorXYResponse(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new XelaSensorXYResponse(null);
...
module.exports = {
  Request: XelaSensorXYRequest,
  Response: XelaSensorXYResponse,
  md5sum() { return '2f5e77e17dc96027c90e428d83f92b92'; },
  datatype() { return 'xela_server/XelaSensorXY'; }
};
