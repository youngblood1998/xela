...
async def start_server():
    ...
    while ncd:
        try:
            await sio.connect('http://localhost:5000', namespaces=["/sensor2"])
...
pub_all_data = rospy.Publisher('xela/2_all_data_raw', xela_msg, queue_size=1000)
pub_x_data = rospy.Publisher('xela/2_x_data_raw', xela_msg, queue_size=1000)
pub_y_data = rospy.Publisher('xela/2_y_data_raw', xela_msg, queue_size=1000)
pub_z_data = rospy.Publisher('xela/2_z_data_raw', xela_msg, queue_size=1000)
